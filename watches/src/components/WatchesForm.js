...
export default function WatchesForm({ handleChange, btnChange, form }) {
  return (
    <form onSubmit={btnChange} className="WatchesForm">
      <div className="form">
      ...
      <div className="form">
        <button className=" inputWatch btn">Добавить</button>
      </div>
    </form>
  );
}
